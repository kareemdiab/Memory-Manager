...
/**
 * Doubly linked list to represent the free block list.
 * 
...
public class FreeList<E> {
     ...
     */
    private void init() {
        head = new FreeList.Node<E>(null);
        tail = new FreeList.Node<E>(null);
        head.setNext(tail);
...
// }
     ...
     * @author Kareem Diab (kareemdiab3)
     * @version 2022.03.31
     *          Iterator class to traverse doubly linked list.
     *
     * @param <A>
     *            generic type the iterator will traverse.
     */
    private class DLListIterator<A> implements Iterator<E> {
        ...
        public boolean hasNext() {
            return first.next.getData() != null;
        }
...
// * Generic type
// */
// public class RDLListIterator<A> implements Iterator<E> {
// private Node<E> last;
// private boolean calledPrev;
//
// /**
// * Creates a new DLListIterator
// */
...
// @Override
// public boolean hasNext() {
// return last.previous().getData() != null;
// }
//
//
// /**
